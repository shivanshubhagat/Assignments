...
import entity.Hyundai;
import entity.Maruti;
import entity.Toyota;
import utility.NameComparator;
...
public class Admin {
    ...
    public static ArrayList<Customer> customerArl = new ArrayList<>();
        ...
        for (Customer c : customerArl) {
            ...
            for (Car carObj : c.carArl) {
                ...
                System.out.println("Car ID:" + carObj.getCarId()
                        ...
                        + "\nResale Price: " + carObj.getResaleValue());
            }
            System.out.println("-------------------");
        }
    }
